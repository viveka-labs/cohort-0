...
/**
 * Image placeholder icon — landscape/photo icon used in empty thumbnail areas.
 * Default stroke is #A1A1AA (zinc-400) at 40% opacity to match the design.
 */
export function ImagePlaceholderIcon({ className, size = 32 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Upvote arrow icon — small chevron-up used for upvote counts.
 * Uses currentColor so it inherits from the parent text color.
 */
export function UpvoteIcon({ className, size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
